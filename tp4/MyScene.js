...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.texturebot = new CGFtexture(this, 'images/mineBottom.png');
        ...
        this.cube = new MyUnitCubeQuad(this, this.texturetop, this.textureside, this.textureside, this.textureside, this.textureside, this.texturebot);

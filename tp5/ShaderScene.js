...
export class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.testShaders = [
			...
			new CGFshader(this.gl, "shaders/teapotAnim.vert", "shaders/teapotAnim.frag"),
	...
	update(t) {
		...
		if (this.selectedExampleShader == 10);
			this.testShaders[10].setUniformsValues({ timeFactor: t / 1000 % 100 });
		
		if (this.selectedExampleShader == 12);
			this.testShaders[12].setUniformsValues({ timeFactor: t / 10000 % 100 });
	}
